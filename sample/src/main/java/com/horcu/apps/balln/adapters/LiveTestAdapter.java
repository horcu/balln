...
public class LiveTestAdapter extends RecyclerView.Adapter<LiveTestAdapter.ViewHolder> implements
        StickyHeaderAdapter<LiveTestAdapter.HeaderHolder> {

    private LayoutInflater mInflater;

    public LiveTestAdapter(Context context) {
