...
//        if(side == 0) //offense
//        {
//            players = (ArrayList<Player>) game.getAwayTeamId().getOffenseId().getPositions().get(position).getPlayers();
//        }
//        else if(side == 1) //defense
//        {
//            players = (ArrayList<Player>) game.getAwayTeamId().getDefenseId().getPositions().get(position).getPlayers();
//        }
//        else //teams
//        {
//            players = (ArrayList<Player>) game.getAwayTeamId().getSpecialTeamsId().getPositions().get(position).getPlayers();
//        }
...
//        ArrayList<Player> players  = new Select() ArrayList<Player>) game.getAwayTeamId().getOffenseId().getPositions().get(8).getPlayers();
//        for(int i = 0; i < players.size(); i++)
//        {
//            Player p=  players.get(i);
